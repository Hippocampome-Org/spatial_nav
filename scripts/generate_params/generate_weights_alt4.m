% weight distribution designer with no preferred direction biases
%
...
start_x_shift = (grid_size/2) - 21;%24;%19;%17;%44;%20;%50;%44;%- 44;%1;%28; -2 = 2 down
start_y_shift = (grid_size/2) - 21;%24;%19;%17;%44;%20;%50;%44;%- 44;%1;%-4;%28; +2 = 2 left
...
function synapse_weights3=shift_weights(po,i,synapse_weights2)
	...
	start_x_shift=po(9);start_y_shift=po(10);layer_sft=po(11);

	ti = (grid_size^2)-1;
	for i2=0:ti
		x = mod(i2,grid_size)+1;
		y = floor(i2/grid_size)+1;
		x2 = x + mod(i,layer_sft);
		y2 = y + floor(i/layer_sft);
