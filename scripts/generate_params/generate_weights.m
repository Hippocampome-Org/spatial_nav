...
grid_size_target = 40;%42; % target grid size for neuron weights
...
start_x_shift = (grid_size/2) - 19;%20;%44;%20;%50;%44;%- 44;%1;%28; -2 = 2 down
start_y_shift = (grid_size/2) - 19;%20;%44;%20;%50;%44;%- 44;%1;%-4;%28; +2 = 2 left
p1=.68;p2=2;p3=2;
p4=38*3;%*1.4;%1.344;%*2.7*(14/20);%1.4;%*.5; % center size
p5=p3;p6=p4;
p7=0.15*1;%0.174*1.4;%*2.4*(14/20);%1.4;%*.75;%0.15; % surround size
p8=.135;p9=2;p10=2;p11=2;p12=p4;p13=p11;p14=p11;p15=p12;
p16=0.81*1;%0.9396*1.4*.9;%*3*(14/20);%1.4;%*.75;%0.81; % surround size
p17=0.0058;
p=[p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17];
tiling_fraction=0.33333333333*1.04*(40/42);%0.1;%0.33333333333;%1;%0.33;%0.5; % fraction of standard tiling distance between bumps
