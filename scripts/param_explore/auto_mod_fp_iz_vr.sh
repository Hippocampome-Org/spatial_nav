...
do
	...
	sed -i "$pat1${p3_p}$pat2${p3_p}$pat3${p3_v[$j]}, ${p3_v[$j]}$pat4" $ea_input_filepath
	sed -i "$pat1${p4_p}$pat2${p4_p}$pat3${p4_v[$j]}, ${p4_v[$j]}$pat4" $ea_input_filepath
	sed -i "$pat1${p5_p}$pat2${p5_p}$pat3${p5_v[$j]}, ${p5_v[$j]}$pat4" $ea_input_filepath
