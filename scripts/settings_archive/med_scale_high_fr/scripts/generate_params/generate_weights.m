...
r_s=0.8*.9*1.18;%1.12;%10/42;%0.8*1.1;%.9;%.9;%.9;%1;%0.8*1.1;%.9;%1;%1.1;%1;%.9;%.8;%.8;%1.01;%1.05;%1.1;%0.9;%1.1;%1;%10/42;%20/42;%1; % ring scale
p1=.54;%150;%14;%16;%16;%10;%.68;%.54;%.52;%.54;%.7;%.76;%.68;%.54;%.6;%.68;%.54;%.5;%.54;%.68;%.54;%.58;%.62;%.68;%10;%20;%.68;%20;%20;%.68;
p2=2;p3=2;
% center size
p4=r_s*52*1.43;%1.2;%*180;%150;%210;%180;%*52;%*1.2;%;%*1.2;%*38*1.6;%*180;%38*1.6;%200;%190;%160;%130;%90;%r_s*52;%35;%45;%52;%40;%70;%130;%38;%*2.5*1.3;%.55;%.7;%4;%2;%2;%2.5;%2;%*1.4;%1.344;%*2.7*(14/20);%1.4;%*.5; 
% center size
p8=r_s*.135*1.02;%*140;%180;%270;%210;%*.135*1.02;%*0.135;%*210;%0.135;%230;%220;%190;%160;%70;%r_s*.135*1.02;%r_s*.135*1.07;%1;%.87;%.135*.9;%1;%.97;%.99;%.11;%.13;%.12;%.14;%.12;%.22;%.2;%.25;%.135; 
% surround size
p7=r_s*0.185;%0.19;%*.5;%.9;%.9;%1.3;%.9;%.7;%0.5;%*0.19;%*0.15;%*0.5;%0.15;%0.13;%0.15;%.3;%0.15;%r_s*0.19;%0.18;%0.19;%0.183;%0.19;%0.2;%0.2;%*1.1*.97;%1.04;%1.05;%1.15;%1;%4;%.7;%.9;%.7;%0.174*1.4;%*2.4*(14/20);%1.4;%*.75;%0.15; 
% surround size
p16=r_s*1.08*.95;%*4.5;%.6;%.45;%.3;%.2;%.15;%*0.3;%*1.08*.95;%0.81;%*0.3;%0.81;%0.3;%1.08*.95*r_s;%1.08*1.03;%1.03;%.95;%1;%.97;%.99;%0.81;%*1.1*.97;%1.04;%1.05;%1.15;%1;%4;%.7;%.9;%.7;%0.9396*1.4*.9;%*3*(14/20);%1.4;%*.75;%0.81; 
