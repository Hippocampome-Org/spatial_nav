...
grid_size_ref = 50;%46;%44;%50;%60;%44; % reference grid size to position shift the center-surround distro for each neuron
grid_size_target = 36;%40;%42;%40;%36;%42; % target grid size for neuron weights
...
start_x_shift = (grid_size/2) - 24;%22;%21;%24;%29;%27;%27;%29;%29.1;%29.1;%29;%29;%24;%29;%24;%29;%24;%5;%24;%19;%26;%6;%26;%19;%20;%19;%17;%44;%20;%50;%44;%- 44;%1;%28; -2 = 2 down
start_y_shift = (grid_size/2) - 24;%22;%21;%24;%29;%27;%27;%27;%27;%29;%24;%29;%24;%29;%24;%5;%24;%19;%26;%6;%26;%19;%20;%19;%17;%44;%20;%50;%44;%- 44;%1;%-4;%28; +2 = 2 left
...
r_s=10/42*.85;%.9;%.8;%.9;%.8;%0.8*.9*.9;%*1.18;%1.12;%10/42;%0.8*1.1;%.9;%.9;%.9;%1;%0.8*1.1;%.9;%1;%1.1;%1;%.9;%.8;%.8;%1.01;%1.05;%1.1;%0.9;%1.1;%1;%10/42;%20/42;%1; % ring scale
p1=10;%.54;%150;%14;%16;%16;%10;%.68;%.54;%.52;%.54;%.7;%.76;%.68;%.54;%.6;%.68;%.54;%.5;%.54;%.68;%.54;%.58;%.62;%.68;%10;%20;%.68;%20;%20;%.68;
p2=2;p3=2;
% center size
p4=r_s*215;%180;%225;%210;%180;%r_s*52*1.2;%*180;%150;%210;%180;%*52;%*1.2;%;%*1.2;%*38*1.6;%*180;%38*1.6;%200;%190;%160;%130;%90;%r_s*52;%35;%45;%52;%40;%70;%130;%38;%*2.5*1.3;%.55;%.7;%4;%2;%2;%2.5;%2;%*1.4;%1.344;%*2.7*(14/20);%1.4;%*.5; 
% center size
...
% surround size
p7=r_s*0.8;%1.25;%1;%0.5;%r_s*0.19;%*.5;%.9;%.9;%1.3;%.9;%.7;%0.5;%*0.19;%*0.15;%*0.5;%0.15;%0.13;%0.15;%.3;%0.15;%r_s*0.19;%0.18;%0.19;%0.183;%0.19;%0.2;%0.2;%*1.1*.97;%1.04;%1.05;%1.15;%1;%4;%.7;%.9;%.7;%0.174*1.4;%*2.4*(14/20);%1.4;%*.75;%0.15; 
% surround size
...
tiling_fraction=0.33333333333*0.9004;%0.86;%0.792;%0.86;%0.84;%0.792;%1.04*(40/42)*(40/44);%*1;%1.04*(40/42)*(40/44);%(126/120);%1;%(42/30);%1.05;%*1.04;%0.1;%0.33333333333;%1;%0.33;%0.5; % fraction of standard tiling distance between bumps
