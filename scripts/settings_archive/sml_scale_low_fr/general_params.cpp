...
struct P {
	// general section
	double sim_time = 3631180;//7000;//3631180;//1260120;//350000;//7000;//250000;//8485920;//8485920;//1440140;//1440140;//8553860;//131400;//8485920;//120000//29416*20;//60000*firing_bin;// sim run time in ms
	...
	double pos[2] = {22.3,12.1};//{27.5,12.5};//{21,27};//{28.5,16.75};//{27.5,12.5};//{21,27};//{21,23};//{21,27};//{27.5,12.5};//{21,27};//{27.5,12.5};//{21,27};//{27.5,12.5};//{28.5,16.75};//{21,27};//{23.5,12.5};//{27.5,12.5};//{28.5,16.75};//{26.5,12.5};//{30,20};//{22,7.75};//{30,18};//{9,17};//{22,8}; // virtual animal position tracker. starting position: {x,y}
	double bpos[2] = {22.3,12.1};//{27.5,12.5};//{21,27};//{28.5,16.75};//{27.5,12.5};//{21,27};//{21,23};//{21,27};//{27.5,12.5};//{21,27};//{27.5,12.5};//{21,27};//{27.5,12.5};//{28.5,16.75};//{21,27};//{23.5,12.5};//{27.5,12.5};//{28.5,16.75};//{26.5,12.5};//{30,20};//{22,7.75};//{9,17}; // bump position tracker
	...
	double base_ext = 300; // baseline ext input speed level	
	double speed_signaling = .45; // setting for use of a constant virtual animal speed
	double fast_to_slow_ratio = 0.38/0.62;
	double dir_to_grc_g_fast = 33.082*1.1*.113;//.115;//.12;//.15;//.58;
	...
	double in_to_grc_g_fast = 0.6259622633+((1.786298271-0.6259622633)*.25); // range is perhaps 0.6259622633 to 1.786298271
	...
	float pc_to_grc_g_fast = 71.14*0.130;
	...
	double grid_pattern_rot = -90;//0;//-33.75;//0;//-33.75;//0;//-40;//0;//-40;//0;//15;//0;//15;//-33.75;//0;//15.0;//-33.75;//0;//5;//0;//-33.75;//0;//-33.75;//-45;//-33.75;//-45;//0;//-45;//-22.5;//-45;//0;//15;//15;//-15; // angle value for rotation of grid pattern in plot
