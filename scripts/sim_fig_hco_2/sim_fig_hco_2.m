...
pyra_nR = NeuronReader('../../results/n_CA1_Pyramidal.dat');
axoa_nR = NeuronReader('../../results/n_EC_LII_Axo_Axonic.dat');
bkmp_nR = NeuronReader('../../results/n_EC_LII_Basket_Multipolar.dat');
mppy_nR = NeuronReader('../../results/n_EC_LI_II_Multipolar_Pyramidal.dat');
...
pyra_sR = SpikeReader('../../results/spk_CA1_Pyramidal.dat');
axoa_sR = SpikeReader('../../results/spk_EC_LII_Axo_Axonic.dat');
bkmp_sR = SpikeReader('../../results/spk_EC_LII_Basket_Multipolar.dat');
mppy_sR = SpikeReader('../../results/spk_EC_LI_II_Multipolar_Pyramidal.dat');
...
neuron_numbers=linspace(1,49,49);
...
volt_nn = [55,49,55,123,102,117];%102%86%8%50
colors=[
[.224,.698,.898]; % stel
[.925,.608,.643]; % pyra
[.553,.157,.118]; % mp pyra
